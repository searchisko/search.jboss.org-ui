...
/**
 * @fileoverview A quick workaround for missing deps during compilation.
 *
 * This is used to get rid of compilation error (example follows):
 *
...
goog.provide('org.jboss.search.code.fixDeps');
