...
org.jboss.search.page.templates.hit = function(opt_data, opt_ignored) {
  ...
  if (((opt_data.highlight == null) ? null : opt_data.highlight.comment_body) != null) {
    ...
    var commentList92 = opt_data.highlight.comment_body;
    var commentListLen92 = commentList92.length;
    for (var commentIndex92 = 0; commentIndex92 < commentListLen92; commentIndex92++) {
      var commentData92 = commentList92[commentIndex92];
      output += '<li>' + soy.$$filterNoAutoescape(commentData92) + '&nbsp;&hellip;</li>';
    }
    output += '</ul></div>';
  }
  output += '</div>';
