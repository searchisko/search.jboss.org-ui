...
org.jboss.search.page.templates.hit = function(opt_data, opt_ignored) {
  return '<div class="hit"><div class="left"><p class="avatar"><img src="' + soy.$$escapeHtml(opt_data.fields.contributor_gravatar) + '"></p></div><div class="main"><div class="title"><a href="' + soy.$$escapeHtml(opt_data.fields.dcp_url_view) + '">' + soy.$$escapeHtml(opt_data.fields.dcp_title) + '</a></div><div class="link"><a href="' + soy.$$escapeHtml(opt_data.fields.dcp_url_view) + '">' + soy.$$escapeHtml(opt_data.fields.dcp_url_view_tr) + '</a></div><div class="snippet"><span class="date">' + soy.$$escapeHtml(opt_data.fields.dcp_last_activity_date) + ' - </span>' + soy.$$escapeHtml(opt_data.fields.dcp_description_tr) + '</div></div></div>';
};
