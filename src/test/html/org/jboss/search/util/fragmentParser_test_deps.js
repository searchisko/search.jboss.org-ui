...
goog.addDependency("../../../src/main/javascript_source/org/jboss/search/SearchFieldHandler.js", ['org.jboss.search.SearchFieldHandler'], ['goog.async.Delay', 'goog.Disposable', 'goog.events', 'goog.events.EventType', 'goog.events.KeyCodes', 'goog.events.KeyHandler', 'goog.events.InputHandler', 'goog.debug.Logger']);
goog.addDependency("../../../src/main/javascript_source/org/jboss/search/client/Client.js", ['org.jboss.search.client.Client'], []);
...
goog.addDependency("../../../src/main/javascript_source/org/jboss/search/logging/Logging.js", ['org.jboss.search.logging.Logging'], ['org.jboss.search.util.fragmentParser', 'org.jboss.search.LookUp', 'goog.events', 'goog.history.EventType', 'goog.Disposable', 'goog.debug', 'goog.debug.Console', 'goog.debug.FancyWindow', 'goog.debug.Logger']);
goog.addDependency("../../../src/main/javascript_source/org/jboss/search/page/SearchPage.js", ['org.jboss.search.page.SearchPage'], ['org.jboss.search.LookUp', 'org.jboss.search.util.urlGenerator', 'org.jboss.search.response', 'org.jboss.search.page.templates', 'org.jboss.search.page.SearchPageElements', 'org.jboss.search.page.UserIdle', 'org.jboss.search.Constants', 'org.jboss.search.SearchFieldHandler', 'org.jboss.search.suggestions.query.view.View', 'org.jboss.search.suggestions.event.EventType', 'goog.async.Delay', 'goog.dom', 'goog.dom.classes', 'goog.events', 'goog.events.KeyCodes', 'goog.events.KeyEvent', 'goog.events.EventType', 'goog.events.EventTarget', 'goog.object', 'goog.string', 'goog.Uri', 'goog.debug.Logger']);
...
goog.addDependency("../../../src/main/javascript_source/org/jboss/search/util/fragmentParser.js", ['org.jboss.search.util.fragmentParser', 'org.jboss.search.util.fragmentParser.UI_param', 'org.jboss.search.util.fragmentParser.INTERNAL_param'], ['goog.array', 'goog.string']);
...
goog.addDependency("../../../src/test/javascript/org/jboss/search/util/fragmentParser_test.js", [], ['org.jboss.search.util.fragmentParser', 'org.jboss.search.util.fragmentParser.INTERNAL_param', 'goog.testing.jsunit']);
goog.addDependency("../../../src/test/javascript/org/jboss/search/util/paginationGenerator_test.js", [], ['org.jboss.search.util.paginationGenerator', 'org.jboss.search.Constants', 'goog.Uri', 'goog.testing.jsunit']);
goog.addDependency("../../../src/test/javascript/org/jboss/search/util/urlGenerator_test.js", [], ['org.jboss.search.util.urlGenerator', 'goog.Uri', 'goog.testing.jsunit']);
