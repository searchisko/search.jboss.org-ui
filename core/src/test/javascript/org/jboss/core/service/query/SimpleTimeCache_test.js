...
function testSimpleCache() {
  ...
  var cache = new org.jboss.core.service.query.SimpleTimeCache(0.2); // 200ms
  assertNotNull(cache);
  ...
  setTimeout(function() { cache.put('3', 'Three'); }, 100);
  ...
  setTimeout(function() {goog.dispose(cache)}, 700);
